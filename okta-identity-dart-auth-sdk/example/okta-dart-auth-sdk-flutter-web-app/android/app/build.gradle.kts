...
android {
    namespace = "com.aortem.okta-identity.dart.admin.auth.sample.app"
    ...
    defaultConfig {
        applicationId = "com.aortem.okta-identity.dart.admin.auth.sample.app"
...
dependencies {
    // Import the okta-identity BoM
    implementation(platform("com.google.okta-identity:okta-identity-bom:33.5.1"))


    // TODO: Add the dependencies for okta-identity products you want to use
    // When using the BoM, don't specify versions in okta-identity dependencies
    implementation("com.google.okta-identity:okta-identity-analytics")


    // Add the dependencies for any other desired okta-identity products
    // https://okta-identity.google.com/docs/android/setup#available-libraries
}
